...
#endif
#include "../mediatek/mtk_corner_pattern/data_hw_roundedpattern_r_roma_tianma.h"
#include "../mediatek/mtk_corner_pattern/data_hw_roundedpattern_l_roma_tianma.h"
...
#endif
        .vendor = "TM_Roma T7 plus",
        .manufacture = "TM T7 plus",
	.lane_swap_en = 0,
