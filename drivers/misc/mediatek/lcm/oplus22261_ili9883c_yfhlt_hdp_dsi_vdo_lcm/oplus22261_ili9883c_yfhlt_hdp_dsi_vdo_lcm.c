...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->brightness_max = 3440;
	params->brightness_min = 13;
	register_device_proc("lcd", "ili9883c_limu", "22261_yfhlt_ili9883c");
}
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	pr_info("[HW check backlight ili9883c_boe]para_list[0]=%x, para_list[1]=%x, lcm_dimming_flag=%d, level=%d\n", \
	bl_level[1].para_list[0], bl_level[1].para_list[1], lcm_dimming_flag, level);
...
struct LCM_DRIVER oplus22261_ili9883c_yfhlt_hdp_dsi_vdo_lcm_drv =
{
	.name = "oplus22261_ili9883c_yfhlt_hdp_dsi_vdo_lcm",
