...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "ili9883c_lite", "21361_hlt_ili9883c");
}
...
struct LCM_DRIVER oplus21361_ili9883c_hlt_hdp_dsi_vdo_lcm_drv =
{
	.name = "oplus21361_ili9883c_hlt_hdp_dsi_vdo_lcm",
