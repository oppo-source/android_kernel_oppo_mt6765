...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "htl9882n", "boe_htltek");

}

static void lcm_init_power(void)
{
	pr_debug("boe_htl9882n lcm_init_power\n");
	MDELAY(1);
	SET_LCM_VSP_PIN(1);
	MDELAY(3);
	SET_LCM_VSN_PIN(1);
...
{
	pr_debug("boe_htl9882n lcm_suspend_power\n");
...
static void lcm_setbacklight_cmdq(void *handle, unsigned int level)
{
	...
	pr_err("[HW check backlight boe_htl9882n]level=%d,para_list[0]=%x,para_list[1]=%x\n",level,bl_level[0].para_list[0],bl_level[0].para_list[1]);
...
static struct LCM_setting_table set_gamma_enter[] = {
	...
	{0xE0, 0x1B, {0x54, 0xFD, 0x11, 0x2B, 0x51, 0x55, 0x73, 0x8F, 0xB2, 0xCE, 0xA9, \
				0xFC, 0x21, 0x43, 0x65, 0xAA, 0x89, 0xB6, 0xD4, 0xFA, 0xFF, 0x1C, 0x48, 0x7F, 0xAC, 0x03, 0xD8}},
	{0xE1, 0x1B, {0x54, 0xE2, 0x11, 0x2B, 0x51, 0x55, 0x73, 0x8F, 0xB2, 0xCE, 0xA9, \
				0xFC, 0x21, 0x43, 0x65, 0xAA, 0x89, 0xB6, 0xD4, 0xFA, 0xFF, 0x1C, 0x48, 0x7F, 0xAC, 0x03, 0xD8}},
	{0xFF, 0x03, {0x98, 0x82, 0x00}},
};
...
static struct LCM_setting_table set_gamma_exit[] = {
	{0xFF, 0x03, {0x98, 0x82, 0x08}},
	{0xE0, 0x1B, {0x00, 0x25, 0x56, 0x7B, 0xAF, 0x54, 0xDD, 0x04, 0x34, 0x5D, 0xA5, \
				0x9E, 0xD4, 0x05, 0x34, 0xAA, 0x64, 0x9D, 0xC0, 0xEC, 0xFF, 0x11, 0x3E, 0x75, 0xA2, 0x03, 0xEC}},
	{0xE1, 0x1B, {0x00, 0x25, 0x56, 0x7B, 0xAF, 0x54, 0xDD, 0x04, 0x34, 0x5D, 0xA5, \
				0x9E, 0xD4, 0x05, 0x34, 0xAA, 0x64, 0x9D, 0xC0, 0xEC, 0xFF, 0x11, 0x3E, 0x75, 0xA2, 0x03, 0xEC}},
	{0xFF, 0x03, {0x98, 0x82, 0x00}},
};
...
struct LCM_DRIVER oplus20361_boe_htl9882n_hdp_dsi_vdo_lcm_drv = {
	.name = "oplus20361_boe_htl9882n_hdp_dsi_vdo_lcm",
