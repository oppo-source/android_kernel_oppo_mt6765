...
extern void __sched usleep_range(unsigned long min, unsigned long max);

struct LCM_setting_table {
	unsigned int cmd;
	unsigned char count;
	unsigned char para_list[192];
};
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x9B, 0x01, {0x7C}}, /* OSC 32Mhz */
	/* gamma value start */
	{0xFF, 0x03, {0x98, 0x82, 0x08}},
    {0xE0, 0x1B, {0x00, 0x24, 0x50, 0x74, 0xA7, 0x50, 0xD3, 0xF8, 0x26, 0x4C, 0x95, 0x8A, 0xBE, 0xDF, \
        0x1B, 0xAA, 0x4C, 0x85, 0xA8, 0xD5, 0xFE, 0xFA, 0x2A, 0x66, 0x99, 0x03, 0xEC}},
    {0xE1, 0x1B, {0x00, 0x24, 0x50, 0x74, 0xA7, 0x50, 0xD3, 0xF8, 0x26, 0x4C, 0x95, 0x8A, 0xBE, 0xFB, \
        0x1B, 0xAA, 0x4C, 0x85, 0xA8, 0xD5, 0xFE, 0xFA, 0x2A, 0x66, 0x99, 0x03, 0xEC}},
    /* gamma value end */
	/* D3G EN */
	{0xFF, 0x03, {0x98, 0x82, 0x0A}},
    {0x00, 0xAE, {0x00, 0x02, 0x04, 0x07, 0x0C, 0x0F, 0x14, 0x17, 0x1B, 0x1F, 0x23, 0x27, 0x2A, 0x2F, \
        0x32, 0x36, 0x3B, 0x3F, 0x43, 0x47, 0x4A, 0x4E, 0x52, 0x56, 0x5D, 0x65, 0x6C, 0x7C, 0x8B, 0x93, \
        0x9A, 0xA2, 0xA9, 0xB1, 0xB8, 0xC0, 0xC8, 0xCF, 0xD6, 0xDE, 0xE5, 0xED, 0xEF, 0xF1, 0xF2, 0xF3, \
        0xC0, 0x8C, 0x66, 0xB3, 0x14, 0x02, 0x73, 0x31, 0x2B, 0xB9, 0x1B, 0x0F, 0x00, 0x02, 0x04, 0x08, \
        0x0C, 0x10, 0x14, 0x18, 0x1C, 0x20, 0x24, 0x28, 0x2C, 0x30, 0x34, 0x38, 0x3C, 0x40, 0x44, 0x48, \
        0x4C, 0x50, 0x54, 0x58, 0x60, 0x67, 0x70, 0x7F, 0x8F, 0x98, 0x9F, 0xA7, 0xAF, 0xB7, 0xBF, 0xC8, \
        0xCF, 0xD7, 0xE0, 0xE8, 0xF0, 0xF8, 0xFA, 0xFC, 0xFE, 0xFF, 0x04, 0x51, 0x66, 0x54, 0xFE, 0x56, \
        0xCC, 0xA2, 0x17, 0x0F, 0x01, 0x00, 0x00, 0x01, 0x03, 0x08, 0x0C, 0x10, 0x13, 0x15, 0x19, 0x1D, \
        0x21, 0x25, 0x29, 0x2C, 0x30, 0x34, 0x38, 0x3C, 0x40, 0x44, 0x47, 0x4B, 0x4E, 0x52, 0x5A, 0x61, \
        0x68, 0x77, 0x86, 0x8E, 0x96, 0x9D, 0xA4, 0xAC, 0xB4, 0xBB, 0xC3, 0xCB, 0xD3, 0xDA, 0xE2, 0xEA, \
        0xEC, 0xEE, 0xF0, 0xF1, 0xAC, 0xE7, 0x56, 0x68, 0x14, 0xB7, 0xF4, 0x87, 0x8B, 0x95, 0xFA, 0x0F}},
    {0x80, 0x01, {0X01}},
    /* D3G END */
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	register_device_proc("lcd", "ili9882n", "txd_ilitek");
...
static struct LCM_setting_table set_gamma_exit[] = {
	{0xFF, 0x03, {0x98, 0x82, 0x08}},
	{0xE0, 0x1B, {0x00, 0x24, 0x4F, 0x74, 0xA6, 0x50, 0xD3, 0xF9, 0x26, 0x4C, 0x95, 0x8B, \
				0xBF, 0xEF, 0x1F, 0xAA, 0x51, 0x8C, 0xB1, 0xDF, 0xFF, 0x05, 0x36, 0x72, 0xA4, 0x03, 0xEC}},
	{0xE1, 0x1B, {0x00, 0x24, 0x4F, 0x74, 0xA6, 0x50, 0xD3, 0xF9, 0x26, 0x4C, 0x95, 0x8B, \
				0xBF, 0xEF, 0x1F, 0xAA, 0x51, 0x8C, 0xB1, 0xDF, 0xFF, 0x05, 0x36, 0x72, 0xA4, 0x03, 0xEC}},
	{0xFF, 0x03, {0x98, 0x82, 0x0B}},
	{0xFF, 0x03, {0x98, 0x82, 0x00}},
};
...
struct LCM_DRIVER ilt9882n_txd_yogurta_hdp_dsi_vdo_lcm_drv = {
	.name = "ilt9882n_txd_yogurta_hdp_dsi_vdo_lcm",
