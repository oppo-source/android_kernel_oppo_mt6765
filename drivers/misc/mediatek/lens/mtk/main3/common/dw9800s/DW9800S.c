...
#if 0
static int s4DW9800S_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9800S_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800S_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800S_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9800S_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800S_GetFileName(unsigned char *pFileName)
{
