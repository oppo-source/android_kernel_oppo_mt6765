...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		/* soft power on */
        /* DW9800S_CHANEL_IMX709 VCM Driver init*/
...
/* ////////////////////////////////////////////////////////////// */
long DW9800S_CHANEL_IMX709_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9800S_CHANEL_IMX709_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9800S_CHANEL_IMX709_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int DW9800S_CHANEL_IMX709_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9800S_CHANEL_IMX709_GetFileName(unsigned char *pFileName)
{
