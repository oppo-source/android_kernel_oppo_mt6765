...
/*
 * FP5513E4AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "FP5513E4AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long FP5513E4AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5513E4AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
...
int FP5513E4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5513E4AF_GetFileName(unsigned char *pFileName)
{
