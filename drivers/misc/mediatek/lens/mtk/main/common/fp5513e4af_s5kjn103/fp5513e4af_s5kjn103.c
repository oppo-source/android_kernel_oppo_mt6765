...
#define AF_DRVNAME "FP5513E4AF_S5KJN103_DRV"
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	LOG_INF("fp5513_s5kjn103 moveAF ret = %d,a_u4Position = %d\n",ret,a_u4Position);
...
/* ////////////////////////////////////////////////////////////// */
long FP5513E4AF_S5KJN103_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int FP5513E4AF_S5KJN103_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	...
	if (g_u4CurrPosition > g_u4AF_INF && g_u4CurrPosition <= g_u4AF_MACRO) {
			while (pos >= 144) {
				...
				LOG_INF("FP5513E4AF_S5KJN103_Release p%d", pos);
				mdelay(4);
			}
			s4AF_WriteReg(90);
			mdelay(3);
...
int FP5513E4AF_S5KJN103_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int FP5513E4AF_S5KJN103_GetFileName(unsigned char *pFileName)
{
