...
/*
 * DW9827AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9827AF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9827AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9827AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int DW9827AF_PowerDown(struct i2c_client *pstAF_I2Cclient,
            int *pAF_Opened)
{
...
int DW9827AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9827AF_GetFileName(unsigned char *pFileName)
{
...
#endif
int DW9827AF_DoExtLdo(int enable)
{
    LOG_INF("DW9827AF_DoExtLdo enable: %d", enable);
#if !defined(CONFIG_MACH_MT6765)
    if(enable) {
