...
/*
 * GT9764AFI voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9764AFI_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9764AFI_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9764AFI_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	int Ret = 0;
...
int GT9764AFI_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9764AFI_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9764AFI_GetFileName(unsigned char *pFileName)
{
