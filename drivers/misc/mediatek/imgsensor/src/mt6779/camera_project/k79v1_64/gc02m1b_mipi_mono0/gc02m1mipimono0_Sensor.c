...
#include "gc02m1mipimono0_Sensor.h"
...
#define PFX "GC02M1_camera_sensor_mono0"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC02M1_SENSOR_ID0,        //record sensor id defined in Kd_imgsensor.h
