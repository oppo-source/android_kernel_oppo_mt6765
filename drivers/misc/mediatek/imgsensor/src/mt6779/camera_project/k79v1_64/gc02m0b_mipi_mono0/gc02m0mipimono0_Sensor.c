...
#include "gc02m0mipimono0_Sensor.h"
...
#define PFX "GC02M0_camera_sensor_mono0"
...
static imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC02M0_SENSOR_ID0,        //record sensor id defined in Kd_imgsensor.h
