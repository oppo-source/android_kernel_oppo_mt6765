...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4000, 3000,  0,   0, 4000, 3000, 2000, 1500, 0, 0, 2000, 1500, 0, 0, 2000, 1500}, /* custom4 */
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[4] = {
   ...
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x0FA0, 0x0A28, 0x01, 0x00, 0x0000, 0x0000,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
	...
	.i4BlockNumY = 90,
	.iMirrorFlip = 0,
	.i4Crop = { {0,0}, {0, 0}, {0, 372}, {80, 420}, {0, 372}, {0, 0}, {80, 420}, {80, 420}, {0, 0}, {0, 200}},
};
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain > 16 * BASEGAIN) {
		write_cmos_sensor_8(0x0204, (gain2reg(16 * BASEGAIN) >> 8));
		write_cmos_sensor_8(0x0205, (gain2reg(16 * BASEGAIN) & 0xff));
		write_cmos_sensor(0x020E, digital_gain & 0xffff);
	} else {
			...
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				read_eepromData(&EepData[data_index],
								GM1ST_STEREO_START_ADDR,
								DUALCAM_CALI_DATA_LENGTH, 0xA0);
				data_index += DUALCAM_CALI_DATA_LENGTH;
				/*Readout SN data*/
				read_eepromData(&EepData[data_index],
								0xB0, CAMERA_MODULE_SN_LENGTH, 0xA0);
				data_index += CAMERA_MODULE_SN_LENGTH;
				read_eepromData(&EepData[data_index], 0x0, 2, 0xA0);
				data_index += 2;
				read_eepromData(&EepData[data_index], 0x6, 6, 0xA0);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2553000;
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_CUSTOM4:  //  2000*1500
			imgsensor_pd_info.i4BlockNumX = 124;
			imgsensor_pd_info.i4BlockNumY = 90;
		...
		case MSDK_SCENARIO_ID_SLIM_VIDEO: // 4000*2256
			imgsensor_pd_info.i4BlockNumX = 124;
			imgsensor_pd_info.i4BlockNumY = 70;
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info, sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
