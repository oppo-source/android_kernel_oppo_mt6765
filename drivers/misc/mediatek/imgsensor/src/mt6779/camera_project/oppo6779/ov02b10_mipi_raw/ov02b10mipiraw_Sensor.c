...
static kal_uint16 read_module_id(void)
{
	...
	iReadRegI2C(pusendcmd , 2, (u8*)&get_byte,1, SLAVEADDR/*EEPROM_READ_ID*/);
	if (get_byte == 0) {
		iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, SLAVEADDR/*EEPROM_READ_ID*/);
	}
	return get_byte;
            ...
            *sensor_id = ((read_cmos_sensor(0x0200) << 8) | read_cmos_sensor(0x0300));
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(deviceInfo_register_value == 0x00){
                    register_imgsensor_deviceinfo("Cam_r3", DEVICE_VERSION_OV02B10, imgsensor_info.module_id);
