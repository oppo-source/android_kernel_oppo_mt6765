...
static void set_dummy(void)
{
	...
	write_cmos_sensor(0x05, ((imgsensor.frame_length - 2504)*2 >> 8) & 0xFF);
	write_cmos_sensor(0x06, (imgsensor.frame_length - 2504)*2 & 0xFF);
...
static void set_max_framerate(UINT16 framerate,kal_bool min_framelength_en)
{
	...
	imgsensor.frame_length = (frame_length > imgsensor_info.pre.framelength) ? frame_length : imgsensor_info.pre.framelength;
	imgsensor.dummy_line = imgsensor.frame_length - imgsensor_info.pre.framelength;
