...
#include "imx586p2q_eeprom.h"
#include "imgsensor_common.h"

#ifndef OPLUS_FEATURE_CAMERA_COMMON
#define OPLUS_FEATURE_CAMERA_COMMON
#endif
static kal_uint8 EepData[CALI_DATA_MASTER_LENGTH_8ALIGN+CAMERA_MODULE_SN_LENGTH+CAMERA_MODULE_INFO_LENGTH];
				...
				if(deviceInfo_register_value == 0x00){
					...
					deviceInfo_register_value = 0x01;
                                ...
                                read_eepromData(&EepData[data_index],
                                                                ...
                                                                CALI_DATA_MASTER_LENGTH_8ALIGN, SLAVEADDR);

                                data_index += CALI_DATA_MASTER_LENGTH_8ALIGN;
                                /*Readout SN data*/
                                read_eepromData(&EepData[data_index],
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	{
		kal_uint16 data_lens = CALI_DATA_MASTER_LENGTH_8ALIGN
