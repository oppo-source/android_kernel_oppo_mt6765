...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCAL_SUNNY_WIDE_OV8856_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
...
kal_uint16 addr_data_pair_init_sunny_ov8856[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	LOG_INF("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856_table_write_cmos_sensor(addr_data_pair_init_sunny_ov8856,
			   sizeof(addr_data_pair_init_sunny_ov8856) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_sunny_ov8856[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366d, 0x00,
	0x366e, 0x08,
...
#endif
	ov8856_table_write_cmos_sensor(addr_data_pair_preview_sunny_ov8856,
				   sizeof(addr_data_pair_preview_sunny_ov8856) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_sunny_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
kal_uint16 addr_data_pair_capture_15fps_sunny_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
#endif
	if (currefps == 150) {
		ov8856_table_write_cmos_sensor(addr_data_pair_capture_15fps_sunny_ov8856,
					       sizeof(addr_data_pair_capture_15fps_sunny_ov8856) /
					       sizeof(kal_uint16));
	} else {
		ov8856_table_write_cmos_sensor(addr_data_pair_capture_30fps_sunny_ov8856,
					       sizeof(addr_data_pair_capture_30fps_sunny_ov8856) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_normal_video_sunny_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
	ov8856_table_write_cmos_sensor(addr_data_pair_normal_video_sunny_ov8856,
		sizeof(addr_data_pair_normal_video_sunny_ov8856) /
		sizeof(kal_uint16));
}
...
kal_uint16 addr_data_pair_vga_setting_120fps_sunny_ov8856[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366d, 0x11,
	0x366e, 0x08,
...
//		write_cmos_sensor(0x0100, 0x01);
	...
	ov8856_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_sunny_ov8856,
				   sizeof(addr_data_pair_vga_setting_120fps_sunny_ov8856) /
				   sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_custom1_24fps_sunny_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    ov8856_table_write_cmos_sensor(addr_data_pair_custom1_24fps_sunny_ov8856,
                       sizeof(addr_data_pair_custom1_24fps_sunny_ov8856) /
                       sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom2_24fps_sunny_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    ov8856_table_write_cmos_sensor(addr_data_pair_custom2_24fps_sunny_ov8856,
                       sizeof(addr_data_pair_custom2_24fps_sunny_ov8856) /
                       sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			printk("sunny wenhui i2c write id: *sensor_id = 0x%x,imgsensor_info.sensor_id =%x\n",*sensor_id,imgsensor_info.sensor_id);
			if (*sensor_id == OV8856_SENSOR_ID) {
				module_id = read_module_id();
				if(module_id == 0x01){
					*sensor_id = imgsensor_info.sensor_id;
//					hardwareinfo_set_prop(HARDWARE_WIDE_ANGLE_CAM_MOUDULE_ID, "Sunny");
					LOG_INF("Sunny i2c write id: 0x%x, sensor id: 0x%x, ver = 0x%x<0xB1=r2a,0xB0=r1a>\n",
						imgsensor.i2c_write_id, *sensor_id, read_cmos_sensor(0x302A));
					return ERROR_NONE;
				}else {
					*sensor_id = 0xFFFFFFFF;
					pr_err("sunny wide camera match fail");
					return ERROR_SENSOR_CONNECT_FAIL;
				}
			}
			LOG_INF("Read sensor id fail,write_id:0x%x, id: 0x%x, module id:0x%x\n", imgsensor.i2c_write_id, *sensor_id,module_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
