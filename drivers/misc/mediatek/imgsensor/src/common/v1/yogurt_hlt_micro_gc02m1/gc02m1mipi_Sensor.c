...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_HLT_MICRO_GC02M1_SENSOR_ID,
...
kal_uint16 addr_data_pair_init_gc02m1_0[] = {
	/*system*/
	0xfc, 0x01,
	0xf4, 0x41,
	0xf5, 0xc0,
...
kal_uint16 addr_data_pair_preview_gc02m1_0[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_0[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_0[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_0[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_0[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1_0,
		sizeof(addr_data_pair_init_gc02m1_0) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1_0,
		sizeof(addr_data_pair_preview_gc02m1_0) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1_0,
		sizeof(addr_data_pair_capture_gc02m1_0) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1_0,
		sizeof(addr_data_pair_normal_video_gc02m1_0) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1_0,
		sizeof(addr_data_pair_hs_video_gc02m1_0) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1_0,
		sizeof(addr_data_pair_slim_video_gc02m1_0) /
		sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = (return_sensor_id()+2);
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(read_module_id(0x0000) == 0x09){
					*sensor_id = imgsensor_info.sensor_id;
					pr_info("HLT gc02m1 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			...
			pr_info("HLT read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 2;
