...
#include "hi556_txd_mipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURTA_TXD_FRONT_HI556_SENSOR_ID,
	...
	.pre = {
		...
		.framelength = 1987,			//record different mode's framelength
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 84000000,//440M x 2 / 10
	...
	.hs_video = {
        .pclk = 168000000,
        .linelength = 2816,				//record different mode's linelength
		.framelength = 496,				//record different mode's framelength  0x1f0
		.startx = 0,
		.starty = 0,
		...
		.max_framerate = 1200,
		.mipi_pixel_rate = 42000000,//220M x 2 / 10
	},
    .slim_video = {
		.pclk = 168000000,
		.linelength = 2816,
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= YOGURTA_TXD_FRONT_HI556_SENSOR_ID,
	.deviceID = 2,
	.dataLength = 0x078E,
...
static struct stCAM_CAL_CHECKSUM_STRUCT txd_hi556_checksum[MAX_ITEM + 1] =
{
...
static kal_uint16 hi556_txd_table_write_cmos_sensor(
...
{
    return ((read_cmos_sensor(0x0F16) << 8) | read_cmos_sensor(0x0F17) + 6);
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi556_yogurta[] = {
...
{
#if MULTI_WRITE
hi556_txd_table_write_cmos_sensor(
	addr_data_pair_init_hi556_yogurta,
	sizeof(addr_data_pair_init_hi556_yogurta) /
	sizeof(kal_uint16));
#else
...
write_cmos_sensor(0x0b12, 0x001c);
...
write_cmos_sensor(0x0958, 0xeb80);
write_cmos_sensor(0x095a, 0xd74e);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi556_yogurta[] = {
0x0a00, 0x0000, // stream off
0x0b0a, 0x8259,
0x0f30, 0x6925,
0x0f32, 0x7167,
...
#if MULTI_WRITE
	hi556_txd_table_write_cmos_sensor(
		addr_data_pair_preview_hi556_yogurta,
		sizeof(addr_data_pair_preview_hi556_yogurta) /
		sizeof(kal_uint16));
...
write_cmos_sensor(0x0006, 0x07c3);
write_cmos_sensor(0x0a22, 0x0000);
write_cmos_sensor(0x0a12, 0x0510);
write_cmos_sensor(0x0a14, 0x03cc);
write_cmos_sensor(0x003e, 0x0000);
write_cmos_sensor(0x0074, 0x07c1);
write_cmos_sensor(0x0070, 0x03e0);
write_cmos_sensor(0x0804, 0x0208);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi556_yogurta[] = {
	0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7067,
...
kal_uint16 addr_data_pair_capture_30fps_hi556_yogurta[] = {
	0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7067,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi556_txd_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi556_yogurta,
		sizeof(addr_data_pair_capture_30fps_hi556_yogurta) /
		sizeof(kal_uint16));
	} else {
	hi556_txd_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi556_yogurta,
		sizeof(addr_data_pair_capture_fps_hi556_yogurta) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_hi556_yogurta[] = {
	0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7067,
...
#if MULTI_WRITE
hi556_txd_table_write_cmos_sensor(
		addr_data_pair_normal_video_hi556_yogurta,
		sizeof(addr_data_pair_normal_video_hi556_yogurta) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi556_yogurta[] = {
	...
	0x0030, 0x1111,
	0x0032, 0x7711,
	0x0006, 0x020c,//changed for 1ms Vblank
	0x0a22, 0x0100,
	0x0a12, 0x0280,
	0x0a14, 0x01e0,
	0x003e, 0x0000,
...
static void hs_video_setting(void)
{
#if MULTI_WRITE
	hi556_txd_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi556_yogurta,
		sizeof(addr_data_pair_hs_video_hi556_yogurta) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0a00, 0x0000);
	write_cmos_sensor(0x0b0a, 0x8252);
	...
	write_cmos_sensor(0x0006, 0x020c);//changed for 1ms Vblank
	write_cmos_sensor(0x0a22, 0x0100);
	write_cmos_sensor(0x0a12, 0x0280);
	write_cmos_sensor(0x0a14, 0x01e0);
	write_cmos_sensor(0x003e, 0x0000);
	write_cmos_sensor(0x0074, 0x020a);
	write_cmos_sensor(0x0070, 0x0105);
	write_cmos_sensor(0x0804, 0x0200);
	write_cmos_sensor(0x0a04, 0x016a);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi556_yogurta[] = {
    //0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x6925,
	0x0f32, 0x7167,
...
#if MULTI_WRITE
	hi556_txd_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi556_yogurta,
		sizeof(addr_data_pair_slim_video_hi556_yogurta) /
		sizeof(kal_uint16));
#else
...
#if ENABLE_HI556_OTP
static kal_uint16 read_module_id(kal_uint32 addr)
{
    kal_uint16 get_byte=0;
    char pusendcmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) };
    iReadRegI2C(pusendcmd , 2, (u8*)&get_byte,1,0xA8);
    LOG_ERR("txd hi556 module_id: 0x%x\n", get_byte);
    return get_byte;
}
#endif
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(read_module_id(0x0000) == 0x18){
					...
					*sensor_id = 0xFFFFFFFF;
					LOG_INF("hi556 module_id match fail,write id: %x, id: 0x18",read_module_id(0x0000));
					return ERROR_SENSOR_CONNECT_FAIL;
				}
#endif
			}
			LOG_INF("hi556 Read sensor id fail, i2c write id: 0x%x,sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		retry = 2;
		i++;
...
UINT32 YOGURTA_HI556_TXD_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
