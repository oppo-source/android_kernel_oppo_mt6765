...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURTA_QTECH_MAIN_OV13B10_SENSOR_ID,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_qtech_yogurta[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_init_ov13b10_qtech_yogurta) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_qtech_yogurta[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3612, 0x4e,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_preview_ov13b10_qtech_yogurta) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_qtech_yogurta[] = {
//  0x0100, 0x00,
    0x0305, 0x43,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_qtech_yogurta[] = {
	//0x0100, 0x00,
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3612, 0x4e,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_capture_15fps_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
	} else {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_capture_30fps_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_qtech_yogurta[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_video_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_qtech_yogurta[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_hs_video_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_qtech_yogurta[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_slim_video_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_ov13b10_qtech_yogurta[] = {
	//0x0100, 0x00,
	0x0305, 0x46,
	0x3501, 0x0b,
	0x3612, 0x4e,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_custome1_30fps_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_ov13b10_qtech_yogurta[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_ov13b10_qtech_yogurta,
		sizeof(addr_data_pair_custome2_24fps_ov13b10_qtech_yogurta) /
		sizeof(kal_uint16));
#endif
}
...
static kal_uint32 return_sensor_id(void)
{
	return ((read_cmos_sensor(0x300a) << 16) |
		(read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c) + 6);
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == YOGURTA_QTECH_MAIN_OV13B10_SENSOR_ID) {
...
UINT32 YOGURTA_OV13B10_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
