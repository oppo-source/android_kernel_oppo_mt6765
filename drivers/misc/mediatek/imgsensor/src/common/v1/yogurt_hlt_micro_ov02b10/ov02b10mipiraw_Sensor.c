...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = YOGURT_HLT_MICRO_OV02B10_SENSOR_ID,
    .module_id = 0x09,    //0x01 Sunny,0x05 QTEK
...
static kal_uint32 return_sensor_id(void)
{
    ...
    LOG_INF("[%s]ov02b10 sensor id: %d", __func__, ((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03)));
            ...
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    //Oplusimgsensor_Registdeviceinfo("Cam_r3", DEVICE_VERSION_OV02B10, imgsensor_info.module_id);
			   ...
			   printk("OV02B10 get_imgsensor_id error: 0x%x\n", *sensor_id);
...
UINT32 OV02B10_HLT_MICRO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
