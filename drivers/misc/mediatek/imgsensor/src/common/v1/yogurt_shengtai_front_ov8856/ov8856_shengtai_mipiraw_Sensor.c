...
#include "ov8856_shengtai_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_SHENGTAI_FRONT_OV8856_SENSOR_ID,		/*record sensor id defined in Kd_imgsensor.h*/
...
kal_uint16 addr_data_pair_init_ov8856_yogurt[] = {
	0x0103, 0x01,
	0x0302, 0x3c,
	0x0303, 0x01,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	LOG_INF("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856_table_write_cmos_sensor(addr_data_pair_init_ov8856_yogurt,
			   sizeof(addr_data_pair_init_ov8856_yogurt) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856_yogurt[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366d, 0x00,
	0x366e, 0x08,
...
#endif
	ov8856_table_write_cmos_sensor(addr_data_pair_preview_ov8856_yogurt,
				   sizeof(addr_data_pair_preview_ov8856_yogurt) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856_yogurt[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
kal_uint16 addr_data_pair_capture_15fps_ov8856_yogurt[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
#endif
	if (currefps == 150) {
		ov8856_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov8856_yogurt,
					       sizeof(addr_data_pair_capture_15fps_ov8856_yogurt) /
					       sizeof(kal_uint16));
	} else {
		ov8856_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov8856_yogurt,
					       sizeof(addr_data_pair_capture_30fps_ov8856_yogurt) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov8856_yogurt[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366d, 0x11,
	0x366e, 0x08,
...
//		write_cmos_sensor(0x0100, 0x01);
	...
	ov8856_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov8856_yogurt,
				   sizeof(addr_data_pair_vga_setting_120fps_ov8856_yogurt) /
				   sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_custom1_24fps_ov8856_yogurt[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    ov8856_table_write_cmos_sensor(addr_data_pair_custom1_24fps_ov8856_yogurt,
                       sizeof(addr_data_pair_custom1_24fps_ov8856_yogurt) /
                       sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_custom2_24fps_ov8856_yogurt[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366d, 0x00,
	0x366e, 0x10,
...
{
    LOG_INF("E! custom1:%d\n", currefps);
    ov8856_table_write_cmos_sensor(addr_data_pair_custom2_24fps_ov8856_yogurt,
                       sizeof(addr_data_pair_custom2_24fps_ov8856_yogurt) /
                       sizeof(kal_uint16));
}
...
static kal_uint16 read_module_id(kal_uint32 addr)
{
    ...
    LOG_ERR("Shengtai ov8856 module_id: 0x%x\n", get_byte);
    return get_byte;
}
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if(read_module_id(0x0000) == 0x0007){  //module id = 0x07
                    pr_info("ov8856 i2c write id : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					//hardwareinfo_set_prop(HARDWARE_FRONT_CAM, "OV8856");
					//hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "Shengtai");
					return ERROR_NONE;
				}else{
					*sensor_id = 0xFFFFFFFF;
					pr_info("ov8856 module_id match fail,write id: %x, module_id: 0x18",read_module_id(0x0000));
					return ERROR_SENSOR_CONNECT_FAIL;
				}
#endif
				pr_info("i2c write id: 0x%x, sensor id: 0x%x, ver = 0x%x<0xB1=r2a,0xB0=r1a>\n",
