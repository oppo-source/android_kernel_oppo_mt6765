...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERA_SHINETECH_FRONT_OV08D10_SENSOR_ID,
...
static kal_uint16 parkera_shinetech_ov08d10_normal_video_setting[] = {
	...
	0x20, 0x0b,
	0xfd, 0x00,
	0x21, 0x00, //add for pll
	0x11, 0x2a,
	0x14, 0x43,
	0x16, 0x82, //add for pll
	0x1b, 0xee,
	0x1e, 0x23, //13 modify for pll
	0xb7, 0x02,
	0xfd, 0x01,
	0x12, 0x00,
	0x03, 0x0a,
...
{
	table_write_cmos_sensor(parkera_shinetech_ov08d10_init_setting,
		sizeof(parkera_shinetech_ov08d10_init_setting) / sizeof(kal_uint16));
}

static void preview_setting(void)
{
	table_write_cmos_sensor(parkera_shinetech_ov08d10_preview_setting,
		sizeof(parkera_shinetech_ov08d10_preview_setting) / sizeof(kal_uint16));
}

static void capture_setting(void)
{
	table_write_cmos_sensor(parkera_shinetech_ov08d10_capture_setting,
		sizeof(parkera_shinetech_ov08d10_capture_setting) / sizeof(kal_uint16));
}

static void normal_video_setting(void)
{
	table_write_cmos_sensor(parkera_shinetech_ov08d10_normal_video_setting,
