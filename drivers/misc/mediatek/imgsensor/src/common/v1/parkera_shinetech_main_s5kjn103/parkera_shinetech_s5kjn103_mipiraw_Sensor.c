 ...
 * Filename:
 * ---------
 *	 parkera_shinetech_s5kjn103mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "parkera_shinetech_s5kjn103_mipiraw_Sensor.h"
...
#define PFX "parkera_shinetech_s5kjn103_camera_sensor"
#define LOG_1 LOG_INF("parkera_shinetech_s5kjn103,MIPI 4LANE\n")
/****************************   Modify end	**************************/
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)
#define LOG_ERR(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)

#ifdef VENDOR_EDIT
#define DEVICE_VERSION_S5KJN103	 "parkera_shinetech_s5kjn103"
...
#endif
#define PARKERA_SHINETECH_S5KJN1_OTP
#ifdef PARKERA_SHINETECH_S5KJN1_OTP
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERA_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
...
/*parkera 2021/06/23, add for HW_GGC write to sensor start*/
#ifdef PARKERA_SHINETECH_S5KJN1_OTP
...
/*parkera 2021/06/23, add for HW_GGC write to sensor end*/
#endif
...
static void parkera_shinetech_s5kjn103_set_lsc_reg_setting(
...
static kal_uint16 parkera_shinetech_s5kjn103_init_setting[] = {
	0x6028,0x2400,
	0x602A,0x1354,
	0x6F12,0x0100,
	0x6F12,0x7017,
...
static kal_uint16 parkera_shinetech_s5kjn103_capture_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 parkera_shinetech_s5kjn103_preview_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 parkera_shinetech_s5kjn103_normal_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 parkera_shinetech_s5kjn103_hs_video_setting[] = {
	0x6028, 0x4000,
	0x6214, 0x7971,
	0x6218, 0x7150,
	0x0344, 0x0058,
...
static kal_uint16 parkera_shinetech_s5kjn103_slim_video_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 parkera_shinetech_s5kjn103_custom1_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static kal_uint16 parkera_shinetech_s5kjn103_custom2_setting[] = {
	0x6028, 0x2400,
	0x602A, 0x1A28,
	0x6F12, 0x4C00,
	0x602A, 0x065A,
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_init_setting,
		sizeof(parkera_shinetech_s5kjn103_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_preview_setting,
		sizeof(parkera_shinetech_s5kjn103_preview_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_capture_setting,
		sizeof(parkera_shinetech_s5kjn103_capture_setting)/sizeof(kal_uint16));
	LOG_INF("%s 30 fpsX\n", __func__);
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_normal_video_setting,
		sizeof(parkera_shinetech_s5kjn103_normal_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void hs_video_setting(void)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_hs_video_setting,
		sizeof(parkera_shinetech_s5kjn103_hs_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void slim_video_setting(void)
{
	...
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_slim_video_setting,
		sizeof(parkera_shinetech_s5kjn103_slim_video_setting)/sizeof(kal_uint16));
	LOG_INF("X\n");
}
...
static void custom1_setting(void)
{
	...
	/*************MIPI output setting************/
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_custom1_setting,
		sizeof(parkera_shinetech_s5kjn103_custom1_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
...
static void custom2_setting(void)
{
	LOG_INF("%s CUS1_16M_24_FPS E! currefps\n", __func__);
	/*************MIPI output setting************/
	table_write_cmos_sensor(parkera_shinetech_s5kjn103_custom2_setting,
		sizeof(parkera_shinetech_s5kjn103_custom2_setting)/sizeof(kal_uint16));
	LOG_INF("X");
}
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
	{
		...
		parkera_shinetech_s5kjn103_set_lsc_reg_setting(index, feature_data_16,
