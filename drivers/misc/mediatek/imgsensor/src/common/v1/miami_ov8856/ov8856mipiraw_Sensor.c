...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	2, 3264, 2448, 0, 0, 3264, 2448},
	/* video*/
	{ 3296, 2480, 112, 376, 3072, 1728, 3072, 1728, 0,
	0, 3072, 1728, 0, 0, 3072, 1728},
	/*hight speed video */
...
kal_uint16 addr_data_pair_video_ov8856[] = {
	0x3501, 0x9a,
	0x3502, 0x20,
	0x366e, 0x10,
	0x3714, 0x23,
...
static void video_setting(void)
{
	...
	write_cmos_sensor(0x0100, 0x00);
#endif
	ov8856_table_write_cmos_sensor(addr_data_pair_video_ov8856,
		sizeof(addr_data_pair_video_ov8856) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_slim_video_ov8856[] = {
	0x3501, 0x4c,
	0x3502, 0xe0,
	0x366e, 0x08,
	0x3714, 0x27,
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x0100, 0x00);
#endif
	ov8856_table_write_cmos_sensor(addr_data_pair_slim_video_ov8856,
		sizeof(addr_data_pair_slim_video_ov8856) / sizeof(kal_uint16));
