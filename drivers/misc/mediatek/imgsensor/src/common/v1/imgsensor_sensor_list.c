...
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR] = {
    ...
    {YOGURT_TRULY_MAIN_S5K3L6_SENSOR_ID, SENSOR_DRVNAME_YOGURT_TRULY_MAIN_S5K3L6, YOGURT_TRULY_MAIN_S5K3L6_SensorInit},
#endif
#if defined(YOGURT_SUNNY_FRONT_S5K3P9SP)
{YOGURT_SUNNY_FRONT_S5K3P9SP_SENSOR_ID, SENSOR_DRVNAME_YOGURT_SUNNY_FRONT_S5K3P9SP, S5K3P9SP_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_SHENGTAI_MONO_OV02B1B)
{YOGURT_SHENGTAI_MONO_OV02B1B_SENSOR_ID, SENSOR_DRVNAME_YOGURT_SHENGTAI_MONO_OV02B1B, OV02B1B_MIPI_MONO_SensorInit},
#endif
#if defined(YOGURT_HLT_MICRO_GC02M1)
{YOGURT_HLT_MICRO_GC02M1_SENSOR_ID, SENSOR_DRVNAME_YOGURT_HLT_MICRO_GC02M1, GC02M1_HLT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_HLT_MICRO_OV02B10)
{YOGURT_HLT_MICRO_OV02B10_SENSOR_ID, SENSOR_DRVNAME_YOGURT_HLT_MICRO_OV02B10, OV02B10_HLT_MICRO_MIPI_RAW_SensorInit},
#endif
	...
	OV8856_SHENGTAI_RAW_SensorInit},
#endif
...
/* ROI_D */
	...
	{ROID_HI556_SENSOR_ID, SENSOR_DRVNAME_HI556_MIPI_RAW,
		HI556_MIPI_RAW_SensorInit},
#endif
#if defined(GC5035_MIPI_RAW)
	{ROID_GC5035_SENSOR_ID, SENSOR_DRVNAME_GC5035_MIPI_RAW,
		GC5035MIPI_RAW_SensorInit},
#endif
#if defined(HI556_TXD_MIPI_RAW)
	{ROID_HI556_TXD_SENSOR_ID, SENSOR_DRVNAME_HI556_TXD_MIPI_RAW,
		HI556_TXD_MIPI_RAW_SensorInit},
#endif
#if defined(HI1336_MIPI_RAW)
	{ROID_HI1336_SENSOR_ID, SENSOR_DRVNAME_HI1336_MIPI_RAW,
		HI1336_MIPI_RAW_SensorInit},
#endif
#if defined(OV13B10_MIPI_RAW)
	{ROID_OV13B10_SENSOR_ID, SENSOR_DRVNAME_OV13B10_MIPI_RAW,
		OV13B10_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1_MIPI_RAW)
	{ROID_GC02M1_SENSOR_ID, SENSOR_DRVNAME_GC02M1_MIPI_RAW,
		GC02M1_MIPI_RAW_SensorInit},
#endif
#if defined(OV02B10_MIPI_RAW)
	{ROID_OV02B10_SENSOR_ID, SENSOR_DRVNAME_OV02B10_MIPI_RAW,
		OV02B10_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1_SW_MIPI_RAW)
	{ROID_GC02M1_SW_SENSOR_ID, SENSOR_DRVNAME_GC02M1_SW_MIPI_RAW,
		GC02M1_SW_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1B_MIPI_RAW)
	{ROID_GC02M1B_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_MIPI_RAW,
		GC02M1B_MIPI_RAW_SensorInit},
#endif
#if defined(OV02B1B_MIPI_RAW)
	{ROID_OV02B1B_SENSOR_ID, SENSOR_DRVNAME_OV02B1B_MIPI_RAW,
		OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(GC02M1B_SW_MIPI_RAW)
	{ROID_GC02M1B_SW_SENSOR_ID, SENSOR_DRVNAME_GC02M1B_SW_MIPI_RAW,
...
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList_yogurt_parker[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(YOGURT_TRULY_MAIN_S5K3L6)
    {YOGURT_TRULY_MAIN_S5K3L6_SENSOR_ID, SENSOR_DRVNAME_YOGURT_TRULY_MAIN_S5K3L6, YOGURT_TRULY_MAIN_S5K3L6_SensorInit},
#endif
#if defined(YOGURT_QTECH_MAIN_OV13B10)
{YOGURT_QTECH_MAIN_OV13B10_SENSOR_ID,SENSOR_DRVNAME_YOGURT_QTECH_MAIN_OV13B10,YOGURT_OV13B10_QTECH_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_QTECH_FRONT_S5K4H7)
{YOGURT_QTECH_FRONT_S5K4H7_SENSOR_ID,SENSOR_DRVNAME_YOGURT_QTECH_FRONT_S5K4H7,S5K4H7_YOGURT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_CXT_DEPTH_GC02M1B)
{YOGURT_CXT_DEPTH_GC02M1B_MIPI_SENSOR_ID,SENSOR_DRVNAME_YOGURT_CXT_DEPTH_GC02M1B,GC02M1B_CXT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_LHYX_MICRO_GC02K0)
{YOGURT_LHYX_MICRO_GC02K0_SENSOR_ID,SENSOR_DRVNAME_YOGURT_LHYX_MICRO_GC02K0,GC02K0_LHYX_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_LCE_FRONT_HI556)
{YOGURT_LCE_FRONT_HI556_SENSOR_ID,SENSOR_DRVNAME_YOGURT_LCE_FRONT_HI556,HI556_LCE_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_SHENGTAI_FRONT_GC5035)
{YOGURT_SHENGTAI_FRONT_GC5035_SENSOR_ID,SENSOR_DRVNAME_YOGURT_SHENGTAI_FRONT_GC5035,GC5035_SHENGTAI_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_SHENGTAI_FRONT_OV8856)
{YOGURT_SHENGTAI_FRONT_OV8856_SENSOR_ID,SENSOR_DRVNAME_YOGURT_SHENGTAI_FRONT_OV8856,OV8856_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_CXT_MICRO_GC02K0)
{YOGURT_CXT_MICRO_GC02K0_SENSOR_ID,SENSOR_DRVNAME_YOGURT_CXT_MICRO_GC02K0,GC02K0_CXT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_CXT_MICRO_GC02M1)
{YOGURT_CXT_MICRO_GC02M1_SENSOR_ID,SENSOR_DRVNAME_YOGURT_CXT_MICRO_GC02M1,GC02M1_CXT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_HLT_DEPTH_GC02M1B)
{YOGURT_HLT_DEPTH_GC02M1B_MIPI_SENSOR_ID,SENSOR_DRVNAME_YOGURT_HLT_DEPTH_GC02M1B,GC02M1B_YOGURT_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_SHENGTAI_MICRO_GC02K0)
{YOGURT_SHENGTAI_MICRO_GC02K0_SENSOR_ID,SENSOR_DRVNAME_YOGURT_SHENGTAI_MICRO_GC02K0,GC02K0_SHENGTAI_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_LHYX_DEPTH_GC02M1B)
{YOGURT_LHYX_DEPTH_GC02M1B_MIPI_SENSOR_ID,SENSOR_DRVNAME_YOGURT_LHYX_DEPTH_GC02M1B,GC02M1B_LHYX_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURT_SUNNY_FRONT_S5K3P9SP)
{YOGURT_SUNNY_FRONT_S5K3P9SP_SENSOR_ID, SENSOR_DRVNAME_YOGURT_SUNNY_FRONT_S5K3P9SP, S5K3P9SP_MIPI_RAW_SensorInit},
#endif
...
/* e_add new sensor driver here */
struct IMGSENSOR_INIT_FUNC_LIST kdSensorList_yogurta[MAX_NUM_OF_SUPPORT_SENSOR] = {
#if defined(YOGURTA_QTECH_MAIN_OV13B10)
{YOGURTA_QTECH_MAIN_OV13B10_SENSOR_ID,SENSOR_DRVNAME_YOGURTA_QTECH_MAIN_OV13B10,YOGURTA_OV13B10_QTECH_MIPI_RAW_SensorInit},
#endif
#if defined(YOGURTA_SHENGTAI_FRONT_GC5035)
{YOGURTA_SHENGTAI_FRONT_GC5035_SENSOR_ID,SENSOR_DRVNAME_YOGURTA_SHENGTAI_FRONT_GC5035,YOGURTA_GC5035MIPI_SHENGTAI_RAW_SensorInit},
#endif
#if defined(YOGURTA_TXD_FRONT_HI556)
{YOGURTA_TXD_FRONT_HI556_SENSOR_ID,SENSOR_DRVNAME_YOGURTA_TXD_FRONT_HI556,YOGURTA_HI556_TXD_MIPI_RAW_SensorInit},
#endif
