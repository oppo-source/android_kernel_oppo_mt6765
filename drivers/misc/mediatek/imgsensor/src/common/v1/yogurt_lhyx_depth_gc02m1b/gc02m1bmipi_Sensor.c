...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_LHYX_DEPTH_GC02M1B_MIPI_SENSOR_ID, 
...
kal_uint16 addr_data_pair_lhyx_init_gc02m1b[] = {
...
static kal_uint16 addr_data_pair_lhyx_preview_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_capture_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_normal_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_hs_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_slim_video_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_custom1_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x06,
	0x42, 0x34,
	0xfe, 0x00,
...
static kal_uint16 addr_data_pair_lhyx_custom2_gc02m1b[] = {
	0xfe, 0x00,
	0x41, 0x04,
	0x42, 0xf4,
	0xfe, 0x00,
...
static void sensor_init(void)
{
	...
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_init_gc02m1b,
		sizeof(addr_data_pair_lhyx_init_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_preview_gc02m1b,
		sizeof(addr_data_pair_lhyx_preview_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_capture_gc02m1b,
		sizeof(addr_data_pair_lhyx_capture_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_normal_video_gc02m1b,
		sizeof(addr_data_pair_lhyx_normal_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_hs_video_gc02m1b,
		sizeof(addr_data_pair_lhyx_hs_video_gc02m1b) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_slim_video_gc02m1b,
		sizeof(addr_data_pair_lhyx_slim_video_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom1_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_custom1_gc02m1b,
		sizeof(addr_data_pair_lhyx_custom1_gc02m1b) /
		sizeof(kal_uint16));
}
static void custom2_setting(void)
{
	LOG_INF("E\n");
	gc02m1b_table_write_cmos_sensor(
		addr_data_pair_lhyx_custom2_gc02m1b,
		sizeof(addr_data_pair_lhyx_custom2_gc02m1b) /
		sizeof(kal_uint16));
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == YOGURT_LHYX_DEPTH_GC02M1B_MIPI_SENSOR_ID) {
...
UINT32 GC02M1B_LHYX_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
