 ...
 * Filename:
 * ---------
 *	 parkerb_shinetech_s5kjn103mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "parkerb_shinetech_s5kjn103_mipiraw_Sensor.h"
...
#define PFX "parkerb_shinetech_s5kjn103_camera_sensor"
#define LOG_1 LOG_INF("parkerb_shinetech_s5kjn103,MIPI 4LANE\n")
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERB_SHINETECH_MAIN_S5KJN103_SENSOR_ID,
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(parkerb_shinetech_s5kjn103_preview_setting,
		sizeof(parkerb_shinetech_s5kjn103_preview_setting)/sizeof(kal_uint16));
