...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_CXT_MICRO_GC02M1_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1) + 10);
}
...
kal_uint16 addr_data_pair_init_gc02m1_yogurt[] = {
...
kal_uint16 addr_data_pair_preview_gc02m1_yogurt[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_capture_gc02m1_yogurt[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_normal_video_gc02m1_yogurt[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_hs_video_gc02m1_yogurt[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_slim_video_gc02m1_yogurt[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_init_gc02m1_yogurt,
		sizeof(addr_data_pair_init_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_preview_gc02m1_yogurt,
		sizeof(addr_data_pair_preview_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_capture_gc02m1_yogurt,
		sizeof(addr_data_pair_capture_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_normal_video_gc02m1_yogurt,
		sizeof(addr_data_pair_normal_video_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc02m1_yogurt,
		sizeof(addr_data_pair_hs_video_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_slim_video_gc02m1_yogurt,
		sizeof(addr_data_pair_slim_video_gc02m1_yogurt) /
		sizeof(kal_uint16));
}
...
static kal_uint16 read_module_id(kal_uint32 addr)
{
    ...
    LOG_INF("Cxt gc02m1 module_id: 0x%x\n", get_byte);
    return get_byte;
}
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(read_module_id(0x0000) == 0x1D){
					*sensor_id = imgsensor_info.sensor_id;
					pr_info("Cxt gc02m1 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
