 ...
 * Filename:
 * ---------
 *	 parkera_holitech_s5k4h7mipi_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "parkera_holitech_s5k4h7_camera_sensor"
#define LOG_INF(format, args...) pr_debug(PFX "[%s] " format, __func__, ##args)
static DEFINE_SPINLOCK(imgsensor_drv_lock);
#ifndef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
#define PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
#endif
...
#define DEVICE_VERSION_PARKERA_HOLITECH_S5K4H7    "parkera_holitech_s5k4h7"
static kal_uint32 streaming_control(kal_bool enable);
//static uint8_t deviceInfo_register_value;

#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
#define PARKERA_HOLITECH_S5K4H7_MODULE_ID 0x09//Qtech
extern char PARKERA_HOLITECH_S5K4H7_OTP_CheckID(void);
extern void PARKERA_HOLITECH_S5K4H7_OTP_Setting(void);
extern void PARKERA_HOLITECH_S5K4H7_OTP_Release(void);
#endif
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID,	/*PARKERA_HOLITECH_FRONT_S5K4H7_SENSOR_ID = 0x487E */
	...
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	.module_id = PARKERA_HOLITECH_S5K4H7_MODULE_ID,
	#endif
...
#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
unsigned char PARKERA_HOLITECH_S5K4H7_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void PARKERA_HOLITECH_S5K4H7_write_cmos_sensor(u16 addr, u32 para)
{
...
{
	return (((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) + 3);
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	return gain;
}				/*  parkera_holitech_s5k4h7MIPI_SetGain  */
...
static kal_uint16 parkera_holitech_s5k4h7_init_setting[] = {
	0x0100, 0x00,
	0x0B05, 0x01,
	0x3074, 0x06,
	0x3075, 0x2F,
...
static kal_uint16 parkera_holitech_s5k4h7_preview_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 parkera_holitech_s5k4h7_cap_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 parkera_holitech_s5k4h7_cap1_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 parkera_holitech_s5k4h7_normal_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 parkera_holitech_s5k4h7_hs_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
static kal_uint16 parkera_holitech_s5k4h7_slim_video_setting[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
	0x0306, 0x00,
...
{
	table_write_cmos_sensor(parkera_holitech_s5k4h7_init_setting,
		sizeof(parkera_holitech_s5k4h7_init_setting) / sizeof(kal_uint16));
}				/*  parkera_holitech_s5k4h7MIPI_Sensor_Init  */


static void preview_setting(void)
{
	table_write_cmos_sensor(parkera_holitech_s5k4h7_preview_setting,
		sizeof(parkera_holitech_s5k4h7_preview_setting) / sizeof(kal_uint16));
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	PARKERA_HOLITECH_S5K4H7_OTP_Setting();
	#endif
}				/*  parkera_holitech_s5k4h7MIPI_Capture_Setting  */

static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		table_write_cmos_sensor(parkera_holitech_s5k4h7_cap1_setting,
			sizeof(parkera_holitech_s5k4h7_cap1_setting) / sizeof(kal_uint16));
	} else {
		table_write_cmos_sensor(parkera_holitech_s5k4h7_cap_setting,
			sizeof(parkera_holitech_s5k4h7_cap_setting) / sizeof(kal_uint16));
	}
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	PARKERA_HOLITECH_S5K4H7_OTP_Setting();
	#endif
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(parkera_holitech_s5k4h7_normal_video_setting,
		sizeof(parkera_holitech_s5k4h7_normal_video_setting) / sizeof(kal_uint16));
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	PARKERA_HOLITECH_S5K4H7_OTP_Setting();
	#endif
}
...
{
	LOG_INF("EVGA 120fps");
	table_write_cmos_sensor(parkera_holitech_s5k4h7_hs_video_setting,
		sizeof(parkera_holitech_s5k4h7_hs_video_setting) / sizeof(kal_uint16));
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	PARKERA_HOLITECH_S5K4H7_OTP_Setting();
	#endif
}
...
{
	LOG_INF("E");
	table_write_cmos_sensor(parkera_holitech_s5k4h7_slim_video_setting,
		sizeof(parkera_holitech_s5k4h7_slim_video_setting) / sizeof(kal_uint16));
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	PARKERA_HOLITECH_S5K4H7_OTP_Setting();
	#endif
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = return_sensor_id();
		...
		printk("parkera_holitech_s5k4h7 get_umgsensor_id: 0x%x\n",*sensor_id );
	...
	#ifdef PARKERA_HOLITECH_S5K4H7_OTP_ENABLE
	printk("PARKERA_HOLITECH_S5K4H7_OTP_CheckID();\n");
	if(PARKERA_HOLITECH_S5K4H7_MODULE_ID==PARKERA_HOLITECH_S5K4H7_OTP_CheckID())
	{
...
//		hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "Hlt");
	...
	else
	{
		...
		PARKERA_HOLITECH_S5K4H7_OTP_Release();
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	printk("PARKERA_HOLITECH_S5K4H7_OTP_CheckID successfully...\n");
	#endif
	return ERROR_NONE;
}
			  ...
			  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
	return ERROR_NONE;
}		/* parkera_holitech_s5k4h7MIPIPreview */
...
UINT32 PARKERA_HOLITECH_FRONT_S5K4H7_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      parkera_holitech_s5k4h7_MIPI_RAW_SensorInit      */
