...
#define S5K4H7_MODULE_ID 0x05//Qtech
extern char HLT_S5K4H7_YOGURT_OTP_CheckID(void);
extern void HLT_S5K4H7_YOGURT_OTP_Setting(void);
extern void HLT_S5K4H7_YOGURT_OTP_Release(void);
#endif
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_QTECH_FRONT_S5K4H7_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487B */
...
#ifdef S5K4H7_OTP_ENABLE
unsigned char S5K4H7_HLT_YOGURT_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7_HLT_YOGURT_write_cmos_sensor(u16 addr, u32 para)
{
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = return_sensor_id();
		...
		printk("s5k4h7 get_imgsensor_id: 0x%x\n",*sensor_id );
		...
		pr_info("Read sensor id fail, id: 0x%x,0x%x\n",
			imgsensor.i2c_write_id, *sensor_id);
		retry--;
	} while (retry > 0);
	//i++;
	...
	if(S5K4H7_MODULE_ID==HLT_S5K4H7_YOGURT_OTP_CheckID())
	{
...
UINT32 S5K4H7_YOGURT_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
