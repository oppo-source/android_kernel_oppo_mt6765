...
#include "sp2507mipiraw_Sensor.h"
#include "imgsensor_eeprom.h"


#define PFX "sp2507_camera_sensor"
#define LOG_1 cam_pr_debug("SP2507macro,MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = MIAMI_SP2507_SENSOR_ID,
...
{
	gImgEepromInfo.i4CurSensorIdx = 4;
