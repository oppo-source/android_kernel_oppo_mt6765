...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_LCE_FRONT_HI556_SENSOR_ID,
	.checksum_value = 0x55e2a82f,
	.pre = {
		.pclk = 166800000,				//record different mode's pclk
		...
		.max_framerate = 298,
		.mipi_pixel_rate = 83400000,//440M x 2 / 10
	...
	.cap = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 298,
		.mipi_pixel_rate = 166800000,//880M x 2 / 10
	},
	...
	.hs_video = {
		...
		.max_framerate = 1200,
		.mipi_pixel_rate = 41700000,//220M x 2 / 10
	},
    .slim_video = {
		.pclk = 166800000,
		.linelength = 2816,
...
static struct stCAM_CAL_DATAINFO_STRUCT sensor_eeprom_data ={
	.sensorID= YOGURT_LCE_FRONT_HI556_SENSOR_ID,
	.deviceID = 2,
	.dataLength = 0x078E,
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi556_yogurt[] = {
...
hi556_lce_table_write_cmos_sensor(
	addr_data_pair_init_hi556_yogurt,
	sizeof(addr_data_pair_init_hi556_yogurt) /
	sizeof(kal_uint16));
#else
...
write_cmos_sensor(0x0f30, 0x8b35);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi556_yogurt[] = {
0x0a00, 0x0000, // stream off
0x0b0a, 0x8259,
0x0f30, 0x8b35,
0x0f32, 0x7167,
...
#if MULTI_WRITE
	hi556_lce_table_write_cmos_sensor(
		addr_data_pair_preview_hi556_yogurt,
		sizeof(addr_data_pair_preview_hi556_yogurt) /
		sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_hi556_yogurt[] = {
	0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x8b35,
	0x0f32, 0x7067,
...
kal_uint16 addr_data_pair_capture_30fps_hi556_yogurt[] = {
	0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x8b35,
	0x0f32, 0x7067,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi556_lce_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi556_yogurt,
		sizeof(addr_data_pair_capture_30fps_hi556_yogurt) /
		sizeof(kal_uint16));
	} else {
	hi556_lce_table_write_cmos_sensor(
		addr_data_pair_capture_fps_hi556_yogurt,
		sizeof(addr_data_pair_capture_fps_hi556_yogurt) /
		sizeof(kal_uint16));
	}
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi556_yogurt[] = {
...
#if MULTI_WRITE
	hi556_lce_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi556_yogurt,
		sizeof(addr_data_pair_hs_video_hi556_yogurt) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0a00, 0x0000);
	write_cmos_sensor(0x0b0a, 0x8252);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi556_yogurt[] = {
    //0x0a00, 0x0000,
	0x0b0a, 0x8252,
	0x0f30, 0x8b35,
	0x0f32, 0x7167,
...
#if MULTI_WRITE
	hi556_lce_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi556_yogurt,
		sizeof(addr_data_pair_slim_video_hi556_yogurt) /
		sizeof(kal_uint16));
#else
...
static kal_uint16 read_module_id(kal_uint32 addr)
{
    ...
    LOG_ERR("Lce hi556 module_id: 0x%x\n", get_byte);
    return get_byte;
}
			...
			*sensor_id =return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(read_module_id(0x0000) == 0x18){
					pr_info("hi556 i2c write id : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					//hardwareinfo_set_prop(HARDWARE_FRONT_CAM, "HI556");
					//hardwareinfo_set_prop(HARDWARE_FRONT_CAM_MOUDULE_ID, "LCE");
					return ERROR_NONE;
				}else{
					*sensor_id = 0xFFFFFFFF;
					pr_info("hi556 module_id match fail,write id: %x, id: 0x18",read_module_id(0x0000));
					return ERROR_SENSOR_CONNECT_FAIL;
				}
#endif
			}
			pr_info("hi556 Read sensor id fail, i2c write id: 0x%x,sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		retry = 2;
		i++;
