...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_QTECH_MAIN_OV13B10_SENSOR_ID,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_video =
{
    ...
    .i4BlockNumY = 74,
    .i4PosL = {
        {18, 2}, {34, 2}, {10, 14}, {24, 14}, {18, 18}, {34, 18}, {10, 30}, {26, 30}
    },
    .i4PosR = {
        {18, 6}, {34, 6}, {10, 10}, {26, 10}, {18, 22}, {34, 22}, {10, 26}, {26, 26}
    },
    .i4Crop = {
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_3264x2448 =
{
    ...
    .i4BlockNumX = 102,
    .i4BlockNumY = 76,
    .i4PosL = {{10, 10}, {20, 10}, {2, 22}, {18, 22}, {10, 26}, {26, 26}, {2, 38}, {18, 38}},
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10_qtech_yogurt[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_init_ov13b10_qtech_yogurt) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10_qtech_yogurt[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3612, 0x4e,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_preview_ov13b10_qtech_yogurt) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10_qtech_yogurt[] = {
//  0x0100, 0x00,
    0x0305, 0x43,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10_qtech_yogurt[] = {
	//0x0100, 0x00,
	0x0305, 0x46,
	0x3501, 0x0c,
	0x3612, 0x4e,
	...
	0x5000, 0xff,
	0x5001, 0x0f,
	0x5004, 0x00,  //PD Location Manual mode
	0x5016, 0x20,
	0x5017, 0x20,
	0x5018, 0x00,
	0x5019, 0x02,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_capture_15fps_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
	} else {
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_capture_30fps_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10_qtech_yogurt[] = {
//	0x0100, 0x00,
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_video_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10_qtech_yogurt[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_hs_video_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10_qtech_yogurt[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_slim_video_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_ov13b10_qtech_yogurt[] = {
	//0x0100, 0x00,
	0x0305, 0x46,
	0x3501, 0x0b,
	0x3612, 0x4e,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_custome1_30fps_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_ov13b10_qtech_yogurt[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_ov13b10_qtech_yogurt,
		sizeof(addr_data_pair_custome2_24fps_ov13b10_qtech_yogurt) /
		sizeof(kal_uint16));
#endif
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == OV13B10_SENSOR_ID) {
				pr_info("qtech ov13B10 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
#ifdef OV13B10_QTECH_OTP
				if(read_ov13B10_qtech_module_id() == 0x05) {
					*sensor_id = imgsensor_info.sensor_id;
					//hardwareinfo_set_prop(HARDWARE_BACK_CAM_MOUDULE_ID, "Qtech");
					pr_info("qtech ov13B10 get_imgsensor_id *sensor_id = 0x%x\n",*sensor_id);
					return ERROR_NONE;
				}
				else {
            ...
            pr_info("qtech Read sensor id fail:0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 1;
...
UINT32 YOGURT_OV13B10_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
