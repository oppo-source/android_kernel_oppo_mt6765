...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YOGURT_SHENGTAI_FRONT_GC5035_SENSOR_ID,
	.checksum_value = 0xdc9f7d95,
/*darfur change mipi output  ,We will continue to update the register by gcoreinc.com*/
	.pre = {
		.pclk = 89700000,//darfur 0918 desense 26M 897M
		.linelength = 1468,//darfur 0918 desense 26M 897M
		.framelength = 2036,//darfur 0918 desense 26M 897M
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 1296,
		.grabwindow_height = 972,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 89700000,//darfur 0918 desense 26M 897M
		.max_framerate = 300,
	},
	.cap = {
		.pclk = 179400000,//darfur 0918 desense 26M 897M
		.linelength = 2936,//darfur 0918 desense 26M 897M
		.framelength = 2036,//darfur 0918 desense 26M 897M
		.startx = 0,
		.starty = 0,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 179400000,//darfur 0918 desense 26M 897M
		.max_framerate = 300,
	},
	.cap1 = {
		.pclk = 145600000,//darfur 0918 desense 26M 897M
		.linelength = 2936,//darfur 0918 desense 26M 897M
		.framelength = 2036,//darfur 0918 desense 26M 897M
		.startx = 0,
		.starty = 0,
		...
		.grabwindow_height = 1944,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 145600000,//darfur 0918 desense 26M 897M
	...
	.hs_video = {
		.pclk = 179400000,//darfur 0918 desense 26M 897M
		.linelength = 1912,//darfur 0918 desense 26M 897M
		.framelength = 1556,//darfur 0918 desense 26M 897M
		.startx = 0,
		.starty = 0,
...
static kal_uint16 gc5035_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint8 gc5035_otp_identify(void)
{
	...
	write_cmos_sensor(0xf8, 0x45);//darfur 0918 desense 26M 897M
...
static kal_uint16 gc5035_init_setting[] = {
	...
	0xf5, 0xe9,
	0xf6, 0x14,
	0xf8, 0x45,//darfur 0918 desense 26M 897M
	0xf9, 0x82,
	0xfa, 0x00,
	0xfc, 0x81,
	0xfe, 0x00,
	...
	0xfe, 0x00,
	0x05, 0x02,
	0x06, 0xde,//darfur 0918 desense 26M 897M
	0x9d, 0x34,//darfur 0918 desense 26M 897M
	0x09, 0x00,
	0x0a, 0x04,
	0x0b, 0x00,
	0x0c, 0x03,
	...
	0x73, 0x89,
	0x7a, 0x05,
	0x7c, 0xa0,//darfur 0918 desense 26M 897M  add this register
	0x7d, 0xcc,
	0x90, 0x00,
	0xce, 0x18,//darfur 0918 desense 26M 897M
	0xd0, 0xb2,
	0xd2, 0x40,
	0xe6, 0xe0,
	0xfe, 0x02,
	...
	0x18, 0x0f,
	0x21, 0x22,
	0x22, 0x07,//darfur 0918 desense 26M 897M
	0x23, 0x48,
	0x24, 0x12,
	0x25, 0x28,
	0x26, 0x09,//darfur 0918 desense 26M 897M
	0x29, 0x06,
	0x2a, 0x58,
	0x2b, 0x09,//darfur 0918 desense 26M 897M
	0xfe, 0x01,
	0x8c, 0x10,
	0xfe, 0x00,
	0x3e, 0x01
...
{
	cam_pr_debug("[%s] init_start\n", __func__);
	gc5035_table_write_cmos_sensor(gc5035_init_setting,sizeof(gc5035_init_setting)/sizeof(kal_uint16));
	cam_pr_debug("[%s] End\n", __func__);
}
...
static kal_uint16 gc5035_capture_24fps_setting[] = {
	0xfe, 0x00,
	0x3e, 0x01,
	0xfc, 0x01,
	0xf4, 0x40,
	0xf5, 0xe7,
	0xf6, 0x14,
	0xf8, 0x38,//darfur 0918 desense 26M 897M
	0xf9, 0x82,
	0xfa, 0x00,
	0xfc, 0x81,
	0xfe, 0x00,
	...
	0x22, 0x07,//darfur 0918 desense 26M 897M
	0x26, 0x08,
	0x29, 0x09,//darfur 0918 desense 26M 897M
	0x2b, 0x09,//darfur 0918 desense 26M 897M
	0xfe, 0x01,
	0x8c, 0x10
};
...
{
	cam_pr_debug("%s fps E! currefps:%d\n", __func__, currefps);
	/*************MIPI output setting************/
	if (currefps == 240) {
		gc5035_table_write_cmos_sensor(gc5035_capture_24fps_setting,
			sizeof(gc5035_capture_24fps_setting)/sizeof(kal_uint16));
	} else {
		gc5035_table_write_cmos_sensor(gc5035_capture_setting,
			sizeof(gc5035_capture_setting)/sizeof(kal_uint16));
	}

	cam_pr_debug("%s fps X\n", __func__);
}
static kal_uint16 gc5035_video_24fps_setting[] = {
	0xfe, 0x00,
	0x3e, 0x01,
	0xfc, 0x01,
	0xf4, 0x40,
...
static kal_uint16 gc5035_video_setting[] = {
	0xfe, 0x00,
	0x3e, 0x01,
	0xfc, 0x01,
	0xf4, 0x40,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	if (currefps == 240) {
	gc5035_table_write_cmos_sensor(gc5035_video_24fps_setting,
		sizeof(gc5035_video_24fps_setting)/sizeof(kal_uint16));
	} else {
	gc5035_table_write_cmos_sensor(gc5035_video_setting,
		sizeof(gc5035_video_setting)/sizeof(kal_uint16));
	}
	cam_pr_debug("X! normal videopfs: %d\n", currefps);
}
static kal_uint16 addr_data_pair_hs_video_gc5035[] = {
	0xfe, 0x00,
	0x3e, 0x01,
	0xfc, 0x01,
	0xf4, 0x40,
	...
	0xfe, 0x00,
	0x05, 0x03,
	0x06, 0xbc,//darfur 0918 desense 26M 897M
	0x9d, 0x34,//darfur 0918 desense 26M 897M
	0x09, 0x00,
	0x0a, 0xf4,
	0x0b, 0x00,
...
{
	cam_pr_debug("E\n");
	gc5035_table_write_cmos_sensor(
		addr_data_pair_hs_video_gc5035,
		sizeof(addr_data_pair_hs_video_gc5035) /
		sizeof(kal_uint16));
	cam_pr_debug("X\n");
}
static kal_uint16 addr_data_pair_slim_video_gc5035[] = {
	0xfe, 0x00,
	0x3e, 0x01,
	0xfc, 0x01,
	0xf4, 0x40,
...
static void slim_video_setting(void)
{
	...
	gc5035_table_write_cmos_sensor(
		...
		sizeof(addr_data_pair_slim_video_gc5035) /
		sizeof(kal_uint16));
	cam_pr_debug("X\n");
}
static void custom1_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x06, 0xde);//darfur 0918 desense 26M 897M
	write_cmos_sensor(0x9d, 0x34);//darfur 0918 desense 26M 897M
	write_cmos_sensor(0x09, 0x00);
	...
	write_cmos_sensor(0x22, 0x07);//darfur 0918 desense 26M 897M
	write_cmos_sensor(0x26, 0x08);
	write_cmos_sensor(0x29, 0x09);//darfur 0918 desense 26M 897M
	write_cmos_sensor(0x2b, 0x09);//darfur 0918 desense 26M 897M
	write_cmos_sensor(0xfe, 0x01);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == YOGURT_SHENGTAI_FRONT_GC5035_SENSOR_ID) {
				...
				if(read_gc5035_shengtai_module_id() == 0x17)
				{
					*sensor_id = imgsensor_info.sensor_id;
					...
					pr_info("shengtai gc5035 get_imgsensor_id *sensor_id = 0x%x\n",*sensor_id);
					//return ERROR_NONE;
				}
				else{
					*sensor_id = 0xFFFFFFFF;
					pr_info("Shengtai match fail,so truly");
...
UINT32 GC5035_SHENGTAI_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	cam_pr_debug("E\n");
