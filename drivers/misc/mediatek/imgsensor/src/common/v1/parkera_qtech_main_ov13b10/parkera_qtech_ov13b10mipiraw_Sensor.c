...
#define PFX "parkera_qtech_ov13b10_camera_sensor"
...
#include "parkera_qtech_ov13b10mipiraw_Sensor.h"
...
#define PARKERA_QTECH_OV13B10_OTP

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static kal_uint32 streaming_control(kal_bool enable);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = PARKERA_QTECH_MAIN_OV13B10_SENSOR_ID,
...
static kal_uint16 parkera_qtech_ov13b10_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_parkera_qtech_ov13b10[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x43,
	0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_init_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_init_parkera_qtech_ov13b10) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_parkera_qtech_ov13b10[] = {
	//0x0100, 0x00,
	0x0305, 0x23,
	0x3501, 0x06,
	0x3502, 0x10,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_preview_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_preview_parkera_qtech_ov13b10) / sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_parkera_qtech_ov13b10[] = {
//  0x0100, 0x00,
    0x0305, 0x43,
    0x3501, 0x0c,
    0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_parkera_qtech_ov13b10[] = {
//	0x0100, 0x00,
	0x0305, 0x44,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_capture_15fps_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
	} else {
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_capture_30fps_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_parkera_qtech_ov13b10[] = {
//	0x0100, 0x00,
	0x0305, 0x44,
	0x3501, 0x0c,
	0x3502, 0x10,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_video_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_video_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x46);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_parkera_qtech_ov13b10[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_hs_video_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_hs_video_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_parkera_qtech_ov13b10[] = {
    //0x0100, 0x00,
    0x0305, 0x23,
    0x3501, 0x03,
    0x3502, 0x00,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_slim_video_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_slim_video_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
#else
    //write_cmos_sensor(0x0100, 0x00);
    write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custome1_30fps_parkera_qtech_ov13b10[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome1_30fps_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_custome1_30fps_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custome2_24fps_parkera_qtech_ov13b10[] = {
	0x0305, 0x43,
	0x3501, 0x0c,
	0x3502, 0x10,
	0x3662, 0x92,
...
#if MULTI_WRITE
	parkera_qtech_ov13b10_table_write_cmos_sensor(
		addr_data_pair_custome2_24fps_parkera_qtech_ov13b10,
		sizeof(addr_data_pair_custome2_24fps_parkera_qtech_ov13b10) /
		sizeof(kal_uint16));
#endif
}
...
#ifdef PARKERA_QTECH_OV13B10_OTP
...
static int read_parkera_qtech_ov13b10_module_id(void)
{
	kal_uint16 parkera_qtech_ov13b10_moduleid_id=0x0;
	parkera_qtech_ov13b10_moduleid_id = read_cmos_sensor_qtech_otp(0x0000);
	return parkera_qtech_ov13b10_moduleid_id;
}
#endif

static void read_parkera_qtech_ov13b10_QRSerialdata(UINT8 *parkera_qtech_ov13b10_QRSerialdata,
	UINT32 *feature_para_len)
{
	...
	for(i = 0; i < 17; i++){
		parkera_qtech_ov13b10_QRSerialdata[i] = (kal_int8)read_cmos_sensor_qtech_otp(start_addr + i);
		LOG_INF("read_cmos_sensor_qtech_otp(start_addr + i) = 0x%x\n", read_cmos_sensor_qtech_otp(start_addr + i));
		checksum = checksum + parkera_qtech_ov13b10_QRSerialdata[i];
	}
	checksum = checksum % 255;
	if(read_cmos_sensor_qtech_otp(start_addr+17) == 1 && read_cmos_sensor_qtech_otp(start_addr+18) == checksum ) {
		*feature_para_len = i;
		LOG_INF("parkera_qtech_ov13b10_sn checksum sucess, feature_para_len；%d", *feature_para_len);
	} else {
		*feature_para_len = 0;
		LOG_INF("parkera_qtech_ov13b10_sn checksum failed");
	}
}
...
#ifdef PARKERA_QTECH_OV13B10_OTP
				if(read_parkera_qtech_ov13b10_module_id() == 0x05)
				{
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_SERIANO_IC:
		read_parkera_qtech_ov13b10_QRSerialdata(feature_data_8, feature_para_len);
