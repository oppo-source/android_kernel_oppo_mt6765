...
struct CAMERA_DEVICE_INFO gImgEepromInfo_22693= {
    .i4SensorNum = 4,
    .pCamModuleInfo = {
        {IMX766_SENSOR_ID22693,   0xA0, {0x00, 0x06}, 0xB0, 1, {0x92,0xFF,0xFF,0x94}, "Cam_r0", "im766"},
        ...
        {GC02M1_SENSOR_ID22693, 0xA4, {0x00, 0x05}, 0xB0, 0, {0xFF,0xFF,0xFF,0xFF}, "Cam_r2", "gc02m1"},
    },
    .i4MWDataIdx = IMGSENSOR_SENSOR_IDX_MAIN2,
    .i4MTDataIdx = 0xFF,
    .i4FrontDataIdx = 0xFF,
