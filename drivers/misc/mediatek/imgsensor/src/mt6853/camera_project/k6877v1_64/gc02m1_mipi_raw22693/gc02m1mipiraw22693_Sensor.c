...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID22693,
...
kal_uint16 addr_data_pair_sw_init_gc02m1_roma[] = {
...
kal_uint16 addr_data_pair_sw_preview_gc02m1_roma[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_capture_gc02m1_roma[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_normal_video_gc02m1_roma[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_hs_video_gc02m1_roma[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_slim_video_gc02m1_roma[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1_roma,
		sizeof(addr_data_pair_sw_init_gc02m1_roma) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1_roma,
		sizeof(addr_data_pair_sw_preview_gc02m1_roma) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1_roma,
		sizeof(addr_data_pair_sw_capture_gc02m1_roma) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1_roma,
		sizeof(addr_data_pair_sw_normal_video_gc02m1_roma) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1_roma,
		sizeof(addr_data_pair_sw_hs_video_gc02m1_roma) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1_roma,
		sizeof(addr_data_pair_sw_slim_video_gc02m1_roma) /
		sizeof(kal_uint16));
}
