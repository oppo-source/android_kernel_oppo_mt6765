...
#include "imx766mipiraw22693_Sensor.h"
//#include "imx766_eeprom.h"
#include "imgsensor_eeprom.h"
#include "imx766_seamless22693_switch.h"
...
BYTE imx766_LRC_data_roma[352] = {0};
static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX766_SENSOR_ID22693,
...
void extend_frame_length_roma(kal_uint32 ns)
{
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        imx766_table_write_cmos_sensor(imx766_seamless_preview_roma, sizeof(imx766_seamless_preview_roma) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM7:
    {
        ...
        if (ZOOM2X_AGAIN_THRESHOLD <= ae_ctrl[GAIN_NE_FRM_1]) {
            ...
            imx766_table_write_cmos_sensor(imx766_seamless_custom7_with_high_again_roma, sizeof(imx766_seamless_custom7_with_high_again_roma) / sizeof(kal_uint16));
        } else {
            if (ae_ctrl[GAIN_NE_FRM_1] >= ZOOM2X_AGAIN_50_THRESHOLD && ae_ctrl[GAIN_NE_FRM_1] <= ZOOM2X_AGAIN_150_THRESHOLD) {
                ...
                imx766_table_write_cmos_sensor(imx766_seamless_custom7_with_50_150_again_roma, sizeof(imx766_seamless_custom7_with_50_150_again_roma) / sizeof(kal_uint16));
            } else {
                LOG_INF("optimize capture quality with low again setting");
                imx766_table_write_cmos_sensor(imx766_seamless_custom7_with_low_again_roma, sizeof(imx766_seamless_custom7_with_low_again_roma) / sizeof(kal_uint16));
            }
        }
        if (ae_ctrl) {
        ...
        imx766_table_write_cmos_sensor(imx766_seamless_custom7_Optimize1_roma,sizeof(imx766_seamless_custom7_Optimize1_roma)/sizeof(kal_uint16));
    ...
    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor(imx766_seamless_normal_video_roma, sizeof(imx766_seamless_normal_video_roma) / sizeof(kal_uint16));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CUSTOM4:
    {
        ...
        FMC_GPH_START;
        imx766_table_write_cmos_sensor(imx766_seamless_custom4_roma, sizeof(imx766_seamless_custom4_roma) / sizeof(kal_uint16));
        if (ae_ctrl) {
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_SET_SEAMLESS_EXTEND_FRAME_LENGTH:
        ...
        extend_frame_length_roma((MUINT32) *feature_data);
...
UINT32 IMX766_MIPI_RAW22693_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    ...
    if (pfFunc != NULL)
        *pfFunc = &sensor_func;
    return ERROR_NONE;
} /* IMX766_MIPI_RAW22693_SensorInit */
