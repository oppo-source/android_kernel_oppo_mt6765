 ...
 *
 ****************************************************************************/
#ifndef _S5KHM2SPMIPI_SENSOR_H
#define _S5KHM2SPMIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	kal_uint8 custom7_delay_frame;     //enter custom1 delay frame num
	kal_uint8 custom8_delay_frame;     //enter custom1 delay frame num
	kal_uint8 custom9_delay_frame;     //enter custom1 delay frame num
	kal_uint8 custom10_delay_frame;     //enter custom1 delay frame num
