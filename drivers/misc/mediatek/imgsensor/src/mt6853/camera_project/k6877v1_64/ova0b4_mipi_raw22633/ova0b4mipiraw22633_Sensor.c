...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    ...
    { 11584, 8688,   32, 1104, 11520, 6480,  2880, 1620,    0,    0,  2880, 1620, 0,   0,   2880, 1620},// normal_video
    ...
    { 11584, 8688,   32, 1104, 11520, 6480,  2880, 1620,    0,    0,  2880, 1620, 0,   0,   2880, 1620},// custom2
...
char offset1_cmd[2] = {0};
char offset2_cmd[2] = {0};
static void write_shutter(kal_uint32 shutter)
{
    kal_uint16 realtime_fps = 0;
    kal_uint16 OIS_flag = 0;
    ...
    if(imgsensor.sensor_mode == IMGSENSOR_MODE_VIDEO) {
        char offset1_cmd[2];
        char offset2_cmd[2];
        kal_uint16 offset1 = (imgsensor.frame_length-shutter) / 2;
        kal_uint16 offset2 = last_shutter/2+1687;

        offset1_cmd[0] = (char)(offset1 >> 8);
        offset1_cmd[1] = (char)(offset1 & 0xFF);
        offset2_cmd[0] = (char)(offset2 >> 8);
        offset2_cmd[1] = (char)(offset2 & 0xFF);
        if(offset1 < (imgsensor.frame_length / 2) && shutter < (imgsensor.frame_length-3304-17)&& shutter<4000 ) {
            write_cmos_sensor(0x3208, 0x01);
            write_cmos_sensor(0x3002, 0x08);
            write_cmos_sensor(0x3008, 0x00);
            write_cmos_sensor(0x3844, 0x00);
            write_cmos_sensor(0x385c, offset1_cmd[0]);
            write_cmos_sensor(0x385d, offset1_cmd[1]);
            write_cmos_sensor(0x3863, offset2_cmd[0]);
            write_cmos_sensor(0x3864, offset2_cmd[1]);
            OIS_flag = 1;
        } else {
    ...
    case SENSOR_FEATURE_SEAMLESS_SWITCH:
        {
            ...
            case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
                ...
                break;
            case MSDK_SCENARIO_ID_CUSTOM5:
                TimeIMX = 1000/(imgsensor_info.preview.pclk/imgsensor.frame_length/imgsensor_info.preview.linelength);
                mdelay(TimeIMX);
                break;
            }
