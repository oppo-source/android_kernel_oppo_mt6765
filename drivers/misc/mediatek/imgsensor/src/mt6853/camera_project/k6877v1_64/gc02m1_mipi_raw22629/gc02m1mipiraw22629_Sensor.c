...
#include "gc02m1mipiraw22629_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1_SENSOR_ID22629,
...
kal_uint16 addr_data_pair_sw_init_gc02m1_chengdu[] = {
	
	/*system*/
	0xfc, 0x01,
	0xf4, 0x41,
	0xf5, 0xe3, // c0->e3 For YK
	0xf6, 0x44,
	0xf8, 0x38,
	0xf9, 0x82, 
	0xfa, 0x00, 
...
kal_uint16 addr_data_pair_sw_preview_gc02m1_chengdu[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_capture_gc02m1_chengdu[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_normal_video_gc02m1_chengdu[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_hs_video_gc02m1_chengdu[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};

kal_uint16 addr_data_pair_sw_slim_video_gc02m1_chengdu[] = {
	0xfe, 0x00,
	0x3e, 0x90,
};
...
static void sensor_init(void)
{
	...
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_init_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_init_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_preview_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_preview_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_capture_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_capture_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_normal_video_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_normal_video_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_hs_video_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_hs_video_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	LOG_INF("E\n");
	gc02m1_table_write_cmos_sensor(
		addr_data_pair_sw_slim_video_gc02m1_chengdu,
		sizeof(addr_data_pair_sw_slim_video_gc02m1_chengdu) /
		sizeof(kal_uint16));
}
			...
			if (*sensor_id == GC02M1_SENSOR_ID) {
				*sensor_id = imgsensor_info.sensor_id;
				...
				if (deviceInfo_register_value == 0x00) {
					...
					Eeprom_DataInit(3, GC02M1_SENSOR_ID22629);
