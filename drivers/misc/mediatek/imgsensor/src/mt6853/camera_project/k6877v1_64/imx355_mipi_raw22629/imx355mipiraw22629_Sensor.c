...
#include "imx355mipiraw22629_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID22629,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[] = {
    ...
    {3280, 2464,   416, 312, 2448, 1836, 2448, 1836,   0,   0, 2448, 1836, 612, 459, 1224, 918},//custom2
...
static void read_module_data(void)
{
    ...
    gImgEepromInfo.i4CurSensorId = IMX355_SENSOR_ID22629;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    printk("imx355 get_imgsensor_id----1  0x%x\n",imgsensor_info.sensor_id);
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
            ...
            printk("imx355 get_imgsensor_id----2  0x%x\n",*sensor_id);
            if (*sensor_id == IMX355_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if (deviceInfo_register_value == 0x00) {
                    Eeprom_DataInit(2, IMX355_SENSOR_ID22629);
