...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC800CS_SENSOR_ID_LIJING,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] ={
	...
	{ 3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448},
	/* video */
	{ 3264, 2448, 0, 0, 3264, 2448, 3264, 2448, 0, 304, 3264, 1840, 0, 0, 3264, 1840},
	/* hs video */
...
static void set_shutter(kal_uint16 shutter)
{
    ...
    //write_cmos_sensor8(0x3e20, (shutter >> 20) & 0x0F);  //for long exposure
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_T_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x11,
...
static void normal_video_T_setting(void)
{
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_normal_video_T_w1sc800cswidely,
         sizeof(addr_data_pair_normal_video_T_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
static void normal_video_setting(void)
{
	...
	write_cmos_sensor8(0x36eb,0x0c);
	write_cmos_sensor8(0x36ec,0x0b);
	write_cmos_sensor8(0x36ed,0x34);
	write_cmos_sensor8(0x36fa,0x09);
	...
	write_cmos_sensor8(0x36f9,0x24);
	write_cmos_sensor8(0x302d,0x20);
	write_cmos_sensor8(0x301f,0x3e);
	write_cmos_sensor8(0x3106,0x01);
	...
	write_cmos_sensor8(0x320d,0x08);
	...
	write_cmos_sensor8(0x4002,0xaf);
	write_cmos_sensor8(0x4003,0x28);
	write_cmos_sensor8(0x4004,0x6b);
	write_cmos_sensor8(0x4005,0x00);
	write_cmos_sensor8(0x4006,0x0b);
	write_cmos_sensor8(0x4007,0xc9);
	write_cmos_sensor8(0x4008,0x00);
	write_cmos_sensor8(0x4009,0x9e);
	write_cmos_sensor8(0x440e,0x02);
	write_cmos_sensor8(0x4509,0x30);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36ea,0x11,
...
static void custom1_setting(void)
{
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_custom1_w1sc800cswidely,
         sizeof(addr_data_pair_custom1_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
	...
	write_cmos_sensor8(0x36f9,0x24);
	write_cmos_sensor8(0x302d,0x20);
	write_cmos_sensor8(0x301f,0x30);
	write_cmos_sensor8(0x3106,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36eb,0x1c,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_custom2_w1sc800cswidely,
         sizeof(addr_data_pair_custom2_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom3_w1sc800cswidely[] = {
	0x0103,0x01,
	0x36e9,0x80,
	0x36f9,0x80,
	0x36eb,0x1c,
...
#if MULTI_WRITE
     w1sc800cswidely_table_write_cmos_sensor(
         addr_data_pair_custom3_w1sc800cswidely,
         sizeof(addr_data_pair_custom3_w1sc800cswidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0103,0x01);
				...
				*sensor_id =return_sensor_id() + 1;
				...
				if (*sensor_id == imgsensor_info.sensor_id) {
					...
					if(deviceInfo_register_value == 0x00){
					    Eeprom_DataInit(1, SC800CS_SENSOR_ID_LIJING);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if(is_project(22291)||is_project(22292)){
		LOG_INF("this project is 22291 or 22292 normal_video_T start!");
		spin_lock(&imgsensor_drv_lock);
		imgsensor.sensor_mode = IMGSENSOR_MODE_VIDEO;
		imgsensor.pclk = imgsensor_info.normal_video_T.pclk;
		imgsensor.line_length = imgsensor_info.normal_video_T.linelength;
		imgsensor.frame_length = imgsensor_info.normal_video_T.framelength;
		imgsensor.min_frame_length = imgsensor_info.normal_video_T.framelength;
		imgsensor.current_fps = 300;
		imgsensor.autoflicker_en = KAL_FALSE;
		spin_unlock(&imgsensor_drv_lock);
		normal_video_T_setting();
		LOG_INF("this project is 22291 or 22292 normal_video_T end!");
		return ERROR_NONE;
	} else {
		LOG_INF("this project is 22083 or 22084 normal_video start!");
		spin_lock(&imgsensor_drv_lock);
		imgsensor.sensor_mode = IMGSENSOR_MODE_VIDEO;
		...
		LOG_INF("this project is 22083 or 22084 normal_video end!");
		return ERROR_NONE;
	}
}	/*	normal_video   */
...
static kal_uint32 set_max_framerate_by_scenario(enum MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 framerate)
{
    ...
    switch (scenario_id) {
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            ...
            if(is_project(22291)||is_project(22292))
            {
                LOG_INF("this project is 22291 or 22292");
                frame_length = imgsensor_info.normal_video_T.pclk / framerate * 10 / imgsensor_info.normal_video_T.linelength;
                spin_lock(&imgsensor_drv_lock);
                imgsensor.dummy_line = (frame_length > imgsensor_info.normal_video_T.framelength) ? (frame_length - imgsensor_info.normal_video_T.framelength) : 0;
                imgsensor.frame_length = imgsensor_info.normal_video_T.framelength + imgsensor.dummy_line;
                imgsensor.min_frame_length = imgsensor.frame_length;
                spin_unlock(&imgsensor_drv_lock);
            } else {
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
		switch (*feature_data) {
			...
			{
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
					= imgsensor_info.normal_video_T.pclk;
			} else {
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
	...
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		...
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			...
			{
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
				= (imgsensor_info.normal_video_T.framelength << 16)
					+ imgsensor_info.normal_video_T.linelength;
			} else {
				*(MUINT32 *)(uintptr_t)(*(feature_data + 1))
    ...
    case SENSOR_FEATURE_GET_MIPI_PIXEL_RATE:
    {
        ...
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
            if(is_project(22291)||is_project(22292))
            {
               rate = imgsensor_info.normal_video_T.mipi_pixel_rate;
            } else {
