	...
	struct stCAM_CAL_LIST_STRUCT **ppCamcalList)
{
	...
	*ppCamcalList = &g_camCalList[0];
	#ifdef OPLUS_FEATURE_CAMERA_COMMON
	if (is_project(OPPO_19550) || is_project(OPPO_19551) || is_project(OPPO_19553) || is_project(OPPO_19556) ||
	    is_project(OPPO_19357) || is_project(OPPO_19354) || is_project(OPPO_19358) || is_project(OPPO_19359)) {
