...
static int pascal_probe(struct platform_device *pdev)
{
	...
	if (!(get_Operator_Version() == 131 || get_Operator_Version() == 132
		...
		|| get_Operator_Version() == 176 || get_Operator_Version() == 141
		|| get_Operator_Version() == 142 || get_Operator_Version() == 143
		|| get_Operator_Version() == 144 || get_Operator_Version() == 145
		|| get_Operator_Version() == 146 || get_Operator_Version() == 136
		|| get_Operator_Version() == 137 || get_Operator_Version() == 138
		|| get_Operator_Version() == 139 || get_Operator_Version() == 140)) { // if not pascal,return
		err = -EFAULT;
		goto err;
	}
#endif
