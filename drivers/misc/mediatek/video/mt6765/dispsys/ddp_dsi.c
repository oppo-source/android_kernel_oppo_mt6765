	...
	unsigned char force_update)
{
	...
	DSI_set_cmdq_serially(module, cmdq, hs, para_tbl, size,
		force_update);
	//printk("hxq add log_4");
	cmdqRecFlush(cmdq);
	//printk("hxq add log_5");
	cmdqRecDestroy(cmdq);
	//printk("hxq add log_6");
}
